8Kloud Switcher linking exception
=============================

Copyright (C) 2026 Devin Block

8Kloud Switcher is licensed under the GNU General Public License version 3 or
later; the full text is in LICENSE.md. The following additional permission
applies on top of that license.


Additional permission under GNU GPL version 3 section 7
-------------------------------------------------------

As a special exception, the copyright holder of 8Kloud Switcher gives you
permission to combine 8Kloud Switcher with, and to convey and/or distribute the
...
libraries listed above. If you modify 8Kloud Switcher, you may extend this
